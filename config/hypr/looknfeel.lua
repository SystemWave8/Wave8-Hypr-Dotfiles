...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1, bezier = "quick", style = "slidefade" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 1, bezier = "quick", style = "slidefade" })
